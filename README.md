...
Moreover I added some visualizations of the crypto currency price, that is displayed on the main page after the data processing and model training is done.
